...
export default function DemandSection() {
  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={submit} className="mb-10 space-y-5 rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900 sm:p-8">
        <label className="block">
      ...
      <section>
        <h3 className="mb-3 text-sm font-semibold text-gray-900 dark:text-white">{t('demandMyRequests')}</h3>
